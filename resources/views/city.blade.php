                            ...
                            <tbody>
                                ...
                                @foreach ($allData as $data)
                                    <tr>
                                        ...
                                        <td class="">
                                          <button class="btn btn-sm btn-primary" data-id="{{$data->id}}" data-name="{{$data->name}}" data-state="{{$data->state_id}}"  onclick="openEditModal(this)"><i class="bi bi-pen"></i> Edit</button>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editTopicModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="{{route('post_edit_city')}}">
          @csrf
      <div class="modal-body">
         <input type="hidden" class="form-control"  name="id" id="editid" aria-describedby="id" required>
          <div class="mb-3">
            <label for="editName" class="form-label">City Name <span class="text-danger">*</span></label>
...
<div class="modal fade" id="newModal" tabindex="-1" aria-labelledby="newModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="{{route('post_new_city')}}" >
          @csrf
      <div class="modal-body">
